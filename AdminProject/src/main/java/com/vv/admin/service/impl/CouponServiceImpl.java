...
import com.vv.admin.mapper.CouponMapper;
import com.vv.admin.mapper.TaskMapper;
import com.vv.admin.pojo.dto.CouponDTO;
import com.vv.admin.pojo.dto.TaskDTO;
import com.vv.admin.pojo.vo.CouponEasyExcelVO;
import com.vv.admin.service.CouponService;
import com.vv.admin.utils.DTimeUtils;
import com.vv.admin.utils.OSSUploadUtils;
import com.vv.admin.utils.ReadFileUtils;
import com.vv.admin.utils.UUIDUtils;
...
public class CouponServiceImpl implements CouponService {
    ...
    @Override
    public ResUtils selectCouponList(CouponDTO couponDTO, Integer pageNum, Integer pageSize) {
        // 非空校验
        Page<CouponDTO> page = new Page<CouponDTO>(pageNum, pageSize);
        QueryWrapper<CouponDTO> queryMapper = new QueryWrapper<CouponDTO>();
        String couponId = couponDTO.getCouponId();
        queryMapper.ge(StrUtil.toUnderlineCase(couponId), couponDTO.getCouponId());
        Page<CouponDTO> couponDTOPage = couponMapper.selectPage(page, queryMapper);
        long pages = couponDTOPage.getPages();
        List<CouponDTO> records = couponDTOPage.getRecords();
        long total = couponDTOPage.getTotal();
        return ResUtils.success(records); // todo
    }
